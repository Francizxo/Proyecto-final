...
function Futball() {
    ...
    async function getData() {
      try {
        const response = await axios.get('https://newsapi.org/v2/everything?q=futbol&language=es&sortBy=publishedAt&apiKey=66cc2401f8b54cdb92e90030a001350e');
